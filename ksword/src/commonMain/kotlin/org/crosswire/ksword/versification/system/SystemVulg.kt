...
/**
 * The Vulgate versification system used in Latin Vulgate Bible translations.
 * Features deuterocanonical books mixed into a distinctive order in the Old Testament,
 * and additional books following the standard New Testament.
 *
 * @see gnu.lgpl.License The GNU Lesser General Public License for details.
 * @author DM Smith
 */
internal class SystemVulg : Versification(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT) {

    companion object {
        const val V11N_NAME: String = "Vulg"
        ...
        /* protected */
        private val BOOKS_NT: List<BibleBook> = listOf(
            BibleBook.MATT,
            BibleBook.MARK,
            BibleBook.LUKE,
            BibleBook.JOHN,

...
/**
 * The NRSVA (New Revised Standard Version Apocrypha) versification system.
 * Includes the standard Old Testament followed by extensive deuterocanonical books.
 *
 * @see gnu.lgpl.License The GNU Lesser General Public License for details.
 * @author DM Smith
 */
internal class SystemNRSVA : Versification(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT) {

    companion object {
        const val V11N_NAME: String = "NRSVA"
        ...
        /* protected */
        private val LAST_VERSE_NT: Array<IntArray> = SystemNRSV.LAST_VERSE_NT
    }
}

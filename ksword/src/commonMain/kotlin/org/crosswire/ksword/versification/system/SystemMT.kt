...
/**
 * The MT (Masoretic Text) versification represents the traditional Hebrew Bible book order.
 * It differs from Leningrad only in the placement of Chronicles - positioned at the end
 * after Nehemiah instead of between Malachi and Psalms.
 *
 * @see gnu.lgpl.License The GNU Lesser General Public License for details.
 *
 * @author DM Smith
 */
internal class SystemMT : Versification(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT) {

    companion object {
        const val V11N_NAME: String = "MT"

        /**
         * Books in MT order: Chronicles placed at the end after Nehemiah
         */

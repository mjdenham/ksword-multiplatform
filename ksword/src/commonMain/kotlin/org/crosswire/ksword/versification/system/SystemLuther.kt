...
/**
 * The Luther versification system used in Lutheran Bible translations.
 * Features a reordered New Testament with Peter and John epistles before Hebrews.
 *
 * @see gnu.lgpl.License The GNU Lesser General Public License for details.
 * @author DM Smith
 */
internal class SystemLuther : Versification(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT) {

    companion object {
        const val V11N_NAME: String = "Luther"

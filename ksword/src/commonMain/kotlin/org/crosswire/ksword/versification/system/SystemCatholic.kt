...
/**
 * The Catholic versification includes 46 Old Testament books and 27 New Testament books.
 * It includes the deuterocanonical books: Tobit, Judith, Wisdom, Sirach, Baruch, and 1-2 Maccabees.
 *
 * @author DM Smith
 */
internal class SystemCatholic : Versification(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT) {

    companion object {
        const val V11N_NAME: String = "Catholic"

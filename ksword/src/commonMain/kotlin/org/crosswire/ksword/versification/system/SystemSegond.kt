...
/**
 * L. Segond Bible versification (based on multiple editions).
 *
 * @see gnu.lgpl.License The GNU Lesser General Public License for details.
 *
 * @author DM Smith
 */
internal class SystemSegond : Versification(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT) {

    companion object {
        const val V11N_NAME: String = "Segond"
        ...
        val LAST_VERSE_OT: Array<IntArray> = arrayOf(
            ...
            intArrayOf(
                17, 16, 17, 35, 26, 30, 38, 36, 24, 20,
                47, 8, 59, 56, 33, 34, 16, 30, 37, 27,
                24, 33, 44, 23, 55, 46, 34,
            ),  // Numbers
            intArrayOf(
                54, 34, 51, 49, 31, 27, 89, 26, 23, 36,
                35, 28, 34, 45, 41, 50, 13, 32, 22, 29,
